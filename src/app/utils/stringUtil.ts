...
export function basicStringValidator(value: string, minLength?: number, maxLength?: number): string | null {
...
export function passwordStringValidator(password: string): string | null {
